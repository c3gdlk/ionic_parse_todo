...
module.controller('MainController', ['$scope', '$state', '$ionicSideMenuDelegate', 'appConfig', function($scope, $state, $ionicSideMenuDelegate, appConfig) {
  ...
  $scope.isFeatureEnabled = function(name) {
